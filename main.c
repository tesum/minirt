...
/*   Updated: 2021/07/07 00:49:17 by demilan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char	**argv)
{
	...
	while (i <= g_scene.width)
	{
		...
		{
			uv.x = (double)j / (g_scene.width - 1);
			uv.y = (g_scene.hight - (double)i - 1) / (g_scene.hight - 1);
			...
			color_pixel(castRay(rayOrigin, rayDirection));
